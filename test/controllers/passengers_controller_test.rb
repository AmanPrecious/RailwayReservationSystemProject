...
class PassengersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create passenger" do
    assert_difference("Passenger.count") do
      post passengers_url, params: { passenger: { p_age: @passenger.p_age, p_gender: @passenger.p_gender, p_name: @passenger.p_name } }
    end
  ...
  test "should update passenger" do
    patch passenger_url(@passenger), params: { passenger: { p_age: @passenger.p_age, p_gender: @passenger.p_gender, p_name: @passenger.p_name } }
